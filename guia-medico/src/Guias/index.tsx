...
function Guias(){
  ...
  return(
    <div>
      <NavbarLog menu="paciente"/>
      <h1 className='container d-flex justify-content-center mt-5'>Minhas Guias Médicas</h1>
      <div className='p-5 d-flex flex-wrap justify-content-center'>

        {guias?.filter(({ attributes }) => attributes?.paciente === 'Ana')
  .map(({ id, attributes }) => (
