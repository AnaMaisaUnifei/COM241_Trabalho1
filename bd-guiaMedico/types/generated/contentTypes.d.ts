...
export interface ApiGuiaMedicaGuiaMedica extends Schema.CollectionType {
  collectionName: 'guia_medicas';
  info: {
    singularName: 'guia-medica';
    pluralName: 'guia-medicas';
    displayName: 'Guia-M\u00E9dica';
    description: '';
  };
  options: {
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    cpf: Attribute.String & Attribute.DefaultTo<'11'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::guia-medica.guia-medica': ApiGuiaMedicaGuiaMedica;
